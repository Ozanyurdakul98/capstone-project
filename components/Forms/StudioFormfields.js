  ...
  return (
    <>
      ...
      <fieldset className='listingForm  flex gap-3 '>
        ...
        <FormInput
          labelWrap={{
            css: props.form.openingHours.includes("Always Available")
              ? "radio-formActive"
              : "radio-form",
          }}
          type='radio'
      ...
      <fieldset className='listingForm flex flex-col gap-3'>
        ...
        <h2 className='flex items-center gap-2 pl-5 lg:text-lg'>
          ...
          <TbHandClick className='h-6 w-6 rotate-[-25deg] lg:h-8 lg:w-8' />
        </h2>
        <button
          type='button'
          className={
            props.form.studiotype === "Premium Studio" ? " studiotypeActive " : "studiotype"
          }
          onClick={() => {
      ...
      <fieldset className='listingForm flex flex-col gap-2'>
        ...
        {props.studioService.map((service) => (
          <FormInput
            ...
            type='checkbox'
            labelWrap={{
              css: props.form.studioService.includes(service.id)
                ? "radio-formActive"
                : "radio-form",
            }}
        ...
        <FormInput
          labelWrap={{
            css: props.form.services.includes("Musicproduction")
              ? "radio-formActive"
              : "radio-form",
          }}
          id='musicproduction'
        ...
        <FormInput
          labelWrap={{
            css: props.form.services.includes("Podcast & Audiobooks")
              ? "radio-formActive"
              : "radio-form",
          }}
      ...
      <fieldset className='listingForm   flex flex-wrap gap-3 '>
        ...
        <FormInput
          labelWrap={{
            css: props.form.locationFeatures.includes("Parking")
              ? "radio-formActive"
              : "radio-form",
          }}
          type='checkbox'
        ...
        <FormInput
          labelWrap={{
            css: props.form.locationFeatures.includes("Kitchen")
              ? "radio-formActive"
              : "radio-form",
          }}
          type='checkbox'
        ...
        <FormInput
          labelWrap={{
            css: props.form.locationFeatures.includes("Smoking")
              ? "radio-formActive"
              : "radio-form",
          }}
          type='checkbox'
      ...
      <fieldset className='listingForm  flex flex-col gap-3 '>
        ...
        <FormInput
          labelWrap={{
            css:
              props.form.soundengineer === "No Soundengineer" ? "radio-formActive" : "radio-form",
          }}
          type='radio'
          id='soundengineerNo'
          name='soundengineer'
        ...
        <div
          className={
            props.form.soundengineer.soundengineerPrice ? "radio-formActive" : "radio-form"
          }>
          <FormInput
            labelWrap={{
              css: "cursor-pointer",
          ...
          <FormInput
            ...
            value={
              props.checked.soundengineer === "soundengineerPrice"
                ? props.form.soundengineer.soundengineerPrice
                : 0
            }
            onChange={(event) => {
              props.handleChange(event);
