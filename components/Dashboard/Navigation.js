...
export default function Navigation() {
  ...
  const links = [
    ...
    {
      url: '/dashboard/addstudioservice',
      label: 'Add Studioservice',
      ...
      icon: (
        <div className="relative">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="icon-dashboard relative -left-[2px] z-10">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="icon-dashboard absolute -top-1 -right-[6px] z-20 ">
            <path
              fillRule="evenodd"
