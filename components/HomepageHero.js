...
export function HomepageHero() {
  return (
    <section className='shadow-bt-lg m-auto mt-4 flex flex-col-reverse items-center justify-center px-4 pb-1 md:flex-row lg:gap-10 xl:gap-40'>
      <div className=' max-h-min max-w-md rounded-3xl bg-white p-2 px-10 pb-10 shadow-inner sm:flex sm:flex-col sm:items-center  sm:bg-none  md:shadow-xl'>
        ...
        <p className='text-sm'>
          Is made for the community of music producers and amateur musicians to offer the oppertunity for a free digital
          business card and therefore having more client traction and more efficient targetting.
        </p>
        <p className='pt-2 text-sm'>
          Describe your services & studio and let the users decide by comparing your listing with others.
          <br />
          <Link href='/search/all'>
            <button className=' button mt-4'>View all listings</button>
          </Link>
        </p>
      </div>
